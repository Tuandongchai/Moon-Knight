...
public class Enemy : Entity
{
    ...
    public virtual void AssigneLastAnimName(string _animBoolName)=>lastAnimBoolName = _animBoolName;

    public override void SlowEntityBy(float _slowPercentage, float _slowDuration)
    {
        moveSpeed = defaltMoveSpeed * (1 - _slowPercentage);
