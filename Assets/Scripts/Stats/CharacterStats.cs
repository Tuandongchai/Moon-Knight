...
public class CharacterStats : MonoBehaviour
{
    ...
    public bool isShocked;  //reduce acccuracy by 20%
    ...
    private void AttemptyToApplyAilements(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightingDamage)
    {
        ...
        if (canApplyShock)
            _targetStats.SetupSockStrikeDamage(Mathf.RoundToInt(_lightingDamage * .1f));
    ...
    public void SetupSockStrikeDamage(int _damage) => shockDamage = _damage;
